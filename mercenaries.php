...
function getArrayOfMercenaries() : array {
    return $arr = [
        ...
        ["Великолеплый Ромб", 150, ["полный хаос", "страховка от неудачи"], "Вам надоели однообразные продуманные пугания? Этот новичёк покажет даже матёрым специалистам, как надо действовать в постоянно меняющейся обстановке, где нет ни малейшего намёка на план."],
